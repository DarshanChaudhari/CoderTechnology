...
<body>
	...
	<c:if test="${requestScope.empDetails.projects.size()>0}">
		...
		<table border="1">
			...
			<c:forEach var="i" begin="0" end="${ requestScope.empDetails.projects.size()-1}">
				<tr>
					<td>${ requestScope.empDetails.projects[i].projectId }</td>
					<td>${ requestScope.empDetails.projects[i].title }</td>
				</tr>
			</c:forEach>
		</table>
