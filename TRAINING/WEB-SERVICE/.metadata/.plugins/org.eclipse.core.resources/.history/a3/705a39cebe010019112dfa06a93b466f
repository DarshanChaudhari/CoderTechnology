 ...
 */
@WebService(endpointInterface = "com.jpm.learning.webservice.CalculatorServer") // This endpoint is metnioned so that client cannot access direct to this method.
