...
import com.JunitMyDate.MyDate;
import com.JunitMyDate.MyDateServices;
import com.JunitMyDate.TestDateDifference;
...
public class TestDateToDays {
	...
	public static Collection<Object[]> getTestParameters() {
		...
		try {
			...
			reader = new BufferedReader(new InputStreamReader(TestDateDifference.class.getResourceAsStream("/resources/"+fileName)));
