 ...
 */
@SpringBootApplication /* This will check the whatever services is mentioned in  pom.xml are started in the new project and allow to start it as a web application*/
