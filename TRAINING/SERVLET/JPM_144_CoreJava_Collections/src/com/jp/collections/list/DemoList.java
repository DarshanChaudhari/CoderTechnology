package com.jp.collections.list;
...
import com.jp.collections.Employee;
import com.jp.collections.SortByEmpName;
...
public class DemoList {
	...
	public static void main(String[] args) {
		...
		iter = list.iterator();
		/*while(iter.hasNext())
			System.out.println(iter.next());*/ // or you can write for each below forEach in one line in java 8
		list.forEach(System.out::println);
