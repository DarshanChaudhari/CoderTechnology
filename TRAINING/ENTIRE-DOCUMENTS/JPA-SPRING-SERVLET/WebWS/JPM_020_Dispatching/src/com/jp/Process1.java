...
/*
 * The response if altered by this servlet does not reach to next in chain because
 ...
 * 
 * Form Data: User entries passed through separate connection when method type is POST.
